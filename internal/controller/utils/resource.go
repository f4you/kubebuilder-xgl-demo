...
func NewDeployment(app *v1beta1.Xglwwebapp) *appv1.Deployment {
	d := &appv1.Deployment{}
...
func NewIngress(app *v1beta1.Xglwwebapp) *netv1.Ingress {
	i := &netv1.Ingress{}
...
func NewService(app *v1beta1.Xglwwebapp) *corev1.Service {
	s := &corev1.Service{}
